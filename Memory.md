...
* Pointer-size integer types exist in many languages and match the size of the target platform. This means a program compiled for 32 bit machine and a 64 bit machine may use different integer types for the same named type. Example names: size_t, usize, isize
